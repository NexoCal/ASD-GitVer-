class ArrayListSederhana<E> {
    private Object[] arrayList;
    private static final int DEFAULT_CAPACITY = 10;
    private int size;

    public ArrayListSederhana() {
        this(DEFAULT_CAPACITY);
        this.size = 0;
    }

    public ArrayListSederhana(int capacity) {
        if (capacity <= 0) {
    ...
    public void clear() {
        if (this.size() > 0) {
            this.arrayList = null;
            this.size = 0;
            this.arrayList = new Object[ArrayListSederhana.DEFAULT_CAPACITY];
        }
    }
    ...
    public void remove(Object obj) {
        ...
        System.out.println("Item " + obj + " removed");
    }
